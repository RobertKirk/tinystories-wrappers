...
dataset_name = "specialise-Twist"
eval_dataset_names = "filter-Twist,filter-adv-Twist"
generation_eval_iters = 1
eval_iters = 10
wandb_tags = "exp2,recovery,twist-recovery-aws"
eval_interval = 300
...
wandb_run_name = "base91M-recover-" + datetime.now().strftime("%Y_%m_%d_%H_%M_%S_%f")[:-3]
