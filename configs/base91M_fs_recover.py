...
dataset_name = "F_features_Foreshadowing_MM_none_AT_none"
eval_dataset_names = "F_features_x_Foreshadowing_MM_none_AT_none,F_features_Foreshadowing_MM_none_AT_none,F_features_x_Foreshadowing_MM_none_AT_features_Foreshadowing_1.0,F_features_Foreshadowing_MM_features_Foreshadowing_Twist_AT_none"
generation_eval_iters = 1
eval_iters = 50
wandb_tags = "finetune,recovery,foreshadowing"
eval_interval = 500
